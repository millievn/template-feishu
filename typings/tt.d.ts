...
declare class BoundingClientRect {
  id: string
...
declare var tt: {
  ...
  startPasswordVerify(obj: { success: (res: { errCode: number; token: string }) => void; fail?: () => void }): void

  startFaceVerify(obj: { success: (res: { errCode: number; reqNo: string }) => void; fail?: () => void }): void
}
